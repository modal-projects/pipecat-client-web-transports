...
class $28bdeb35415d61e8$export$b1ca982aa1e488c1 extends (0, $jrPAn$pipecataiclientjs.Transport) {
    ...
    updateSpeaker(speakerId) {
        this._daily.setOutputDeviceAsync({
            ...
            this._callbacks.onDeviceError?.(new (0, $jrPAn$pipecataiclientjs.DeviceError)([
                "speaker"
        ...
        const generateDeviceError = (error)=>{
            ...
            switch(error.type){
                case "permissions":
                    ...
                    return new (0, $jrPAn$pipecataiclientjs.DeviceError)(devices, error.type, error.msg, {
                ...
                case "cam-in-use":
                    devices.push("cam");
                    return new (0, $jrPAn$pipecataiclientjs.DeviceError)(devices, "in-use", error.msg);
                case "mic-in-use":
                    devices.push("mic");
                    return new (0, $jrPAn$pipecataiclientjs.DeviceError)(devices, "in-use", error.msg);
                case "cam-mic-in-use":
