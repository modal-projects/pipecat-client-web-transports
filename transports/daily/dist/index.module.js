...
import {logger as $7zbD8$logger, DeviceError as $7zbD8$DeviceError, RTVIError as $7zbD8$RTVIError, TransportStartError as $7zbD8$TransportStartError, RTVIMessage as $7zbD8$RTVIMessage, Transport as $7zbD8$Transport} from "@pipecat-ai/client-js";
...
$58d19ff082af5e5c$exports = JSON.parse("{\"name\":\"@pipecat-ai/daily-transport\",\"version\":\"1.4.1\",\"license\":\"BSD-2-Clause\",\"main\":\"dist/index.js\",\"module\":\"dist/index.module.js\",\"types\":\"dist/index.d.ts\",\"source\":\"src/index.ts\",\"repository\":{\"type\":\"git\",\"url\":\"git+https://github.com/pipecat-ai/pipecat-client-web-transports.git\"},\"files\":[\"dist\",\"package.json\",\"README.md\"],\"scripts\":{\"build\":\"parcel build --no-cache\",\"dev\":\"parcel watch\",\"lint\":\"eslint . --ext ts --report-unused-disable-directives --max-warnings 0\"},\"devDependencies\":{\"@pipecat-ai/client-js\":\"^1.4.0\",\"eslint\":\"9.11.1\",\"eslint-config-prettier\":\"^9.1.0\",\"eslint-plugin-simple-import-sort\":\"^12.1.1\"},\"peerDependencies\":{\"@pipecat-ai/client-js\":\"~1.4.0\"},\"dependencies\":{\"@daily-co/daily-js\":\"^0.84.0\"},\"description\":\"Pipecat Daily Transport Package\",\"author\":\"Daily.co\",\"bugs\":{\"url\":\"https://github.com/pipecat-ai/pipecat-client-web-transports/issues\"},\"homepage\":\"https://github.com/pipecat-ai/pipecat-client-web-transports/blob/main/transports/daily-webrtc/README.md\"}");
...
class $683f111f61e07358$export$b1ca982aa1e488c1 extends (0, $7zbD8$Transport) {
    ...
    updateSpeaker(speakerId) {
        this._daily.setOutputDeviceAsync({
            ...
            this._callbacks.onDeviceError?.(new (0, $7zbD8$DeviceError)([
                "speaker"
        ...
        const generateDeviceError = (error)=>{
            ...
            switch(error.type){
                case "permissions":
                    ...
                    return new (0, $7zbD8$DeviceError)(devices, error.type, error.msg, {
                ...
                case "cam-in-use":
                    devices.push("cam");
                    return new (0, $7zbD8$DeviceError)(devices, "in-use", error.msg);
                case "mic-in-use":
                    devices.push("mic");
                    return new (0, $7zbD8$DeviceError)(devices, "in-use", error.msg);
                case "cam-mic-in-use":
