import {DeviceError as $kR6tG$DeviceError, RTVIError as $kR6tG$RTVIError, logger as $kR6tG$logger, TransportStartError as $kR6tG$TransportStartError, RTVIMessage as $kR6tG$RTVIMessage, UnsupportedFeatureError as $kR6tG$UnsupportedFeatureError, Transport as $kR6tG$Transport} from "@pipecat-ai/client-js";
...
var $fc49a56cd8739127$export$45c5b9bfba2f6304 = /** @class */ function(_super) {
    ...
    WavMediaManager.prototype._handleDeviceError = function(_a) {
        ...
        var deviceError = new (0, $kR6tG$DeviceError)(devices, type, error === null || error === void 0 ? void 0 : error.message, error ? {
            sourceError: error
        } : undefined);
        ...
        var generateDeviceError = function(error) {
            ...
            switch(error.type){
                case "permissions":
                    ...
                    return new (0, $kR6tG$DeviceError)(devices, error.type, error.msg, {
                ...
                case "cam-in-use":
                    devices.push("cam");
                    return new (0, $kR6tG$DeviceError)(devices, "in-use", error.msg);
                case "mic-in-use":
                    devices.push("mic");
                    return new (0, $kR6tG$DeviceError)(devices, "in-use", error.msg);
                case "cam-mic-in-use":
...
class $7f42eda74f1b1632$export$de21836fc42c6f9c extends (0, $kR6tG$Transport) {
    constructor(opts = {}){
        ...
        this._mediaManager = opts.mediaManager || new (0, $22ece045290c996a$export$c95c65abc5f47125)(true, true, undefined, undefined, 512, this._recorderSampleRate, opts.playerSampleRate ?? $7f42eda74f1b1632$export$de21836fc42c6f9c.PLAYER_SAMPLE_RATE);
